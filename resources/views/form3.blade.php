...
<div class="col-sm-6" style="display: none;">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Advertiser Details</h5>
                  <div class="advertiser-space">
                    <div class="advertiser-details block">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Name: </label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="fullname" disabled value="Test Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Account Type: </label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="type" disabled value="Test Type">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label id="contact_number" class="col-sm-2 col-form-label">Contact Number: </label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="contact_number" value="contact number goes here">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label id="address" class="col-sm-2 col-form-label">Address: </label>
                            <div class="col-sm-10">
