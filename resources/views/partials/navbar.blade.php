    ...
    <ul>
      ...
      @if (Route::has('login'))
        ...
        <li class="dropdown">
            ...
            <ul>
                <li><a class="nav-user-dropdown" href="{{ route('shop.create') }}"><i class="fas fa-dog fa-sm fa-fw mr-2 text-gray-400"></i><span class="badge badge-warning" style="color: black;">Sell a dog</span> </a></li>
